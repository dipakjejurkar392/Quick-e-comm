    ...
    return (
        <div onClick={()=>setShowUserLogin(false)} className='fixed top-0 bottom-0 left-0 right-0 z-30 flex items-center text-sm text-gray-600 bg-black/50'>
            ...
            <p className="text-2xl font-medium m-auto">
                <span className="text-orange-500">User</span> {state === "login" ? "Login" : "Sign Up"}
            </p>
            {state === "register" && (
            ...
            <button className="bg-orange-400 hover:bg-orange-500 transition-all text-white w-full py-2 rounded-md cursor-pointer">
