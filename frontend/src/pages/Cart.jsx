...
const Cart = () => {
    ...
    const [cartArray,setCartAttay] = useState([])
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-sm text-orange-500">{getCartCount()}Items</span>
                </h1>
                ...
                <button onClick={()=>{navigate('/products'); scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 text-orange-500 font-medium">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                              { addresses.map((address,index)=>(
                                ...
                                <p onClick={() => navigate('/add-address')} className="text-orange-500 text-center cursor-pointer p-2 hover:bg-orange-500/10">
                                    Add address
                                </p>
                            </div>
                        )}
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-orange-500 text-white font-medium hover:bg-orange-600 transition">
